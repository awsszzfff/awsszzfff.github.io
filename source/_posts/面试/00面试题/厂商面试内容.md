...
## [250306 安全研究实习 一面](https://blog.csdn.net/m0_62828084/article/details/146027387)
...
## [250307 安全研究实习二面](https://blog.csdn.net/m0_62828084/article/details/146027408) @
...
4. 内网误报存在于办公网还是生产网
5. 比如mysql也会执行powershell，怎么做防护（前面说了内网误报是因为有人写了ps脚本触发的）
...
11. 如何防御sql注入
12. 遇到order by如何防御
13. 遇到转义字符防御时，如果遇到数据库的列名或是表面本身就带有特殊字符时，应该怎么做
14. 宽字节注入的原理
15. ssrf原理
16. ssrf漏洞如何修复
17. 基于黑白名单的修复，现在的生产基本上都是用的docker ，ip是随时会变得，而且docker重启后可能什么都不一样了，怎么做一个修复
18. fastjson反序列化原理
19. redis漏洞
20. mysql提权
21. shiro 反序列化原理
...
## [250307 安全研究实习 三面](https://blog.csdn.net/m0_62828084/article/details/146085910) @

```txt
1. 聊聊攻防演练中比较得意，印象深刻的一次经历
2. CSRF漏洞修复
3. Java系统代码，审计流程
