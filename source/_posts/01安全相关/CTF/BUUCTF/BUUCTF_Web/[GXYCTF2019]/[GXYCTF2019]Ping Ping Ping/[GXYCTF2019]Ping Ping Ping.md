...
![在这里插入图片描述](attachments/14f72a9c46684751b30e07449f03de3b.png)

`ls`查看当前目录文件，有文件名回显，但`cat flag.php`根据回显可以看出 空格 被过滤了。

![在这里插入图片描述](attachments/695672df36154cb1acef27ab6cd35567.png)
![在这里插入图片描述](attachments/cacca52ac47d4b40a76d00ca2efe7831.png)
...
![在这里插入图片描述](attachments/2f39140928fc486a8f3c68a6dfff7101.png)
...
![在这里插入图片描述](attachments/6c5ad1b6135145708bab6fb1e5d85663.png)

wp 中还有 payload：`` ?ip=127.0.0.1;cat$IFS$1`ls` ``，先执行反引号`` ` `  ``中的内容，将其值传递给调用它的命令，查看源代码得出 flag 。

![在这里插入图片描述](attachments/cce51d7872ac44e3922436baa257448d.png)
#### 补充
