...
![[attachments/20250323174255.png]]

基础演示：输入的内容显示在页面中；

![[attachments/20250323171839.png]]

当输入 JS 代码`<script>alert(1)</script>` ，源码没有对其进行过滤，网页则会执行该代码，弹框；

## 存储型

![[attachments/20250323174304.png]]

与反射型类似，存储型较为持久，通常页面与 SQL 后台或其他服务器有交互，将恶意代码存储于服务器端，当其他用户再次访问页面时触发。

## DOM 型

![[attachments/20250323174411.png]]
...
![[attachments/20250945677891.png]]

前端用户提交账户结算申请处存在存储型 XSS 漏洞；

![[attachments/20250849561237.png]]
...
![[attachments/20250623495318.png]]

管理员登录访问结算管理页面则会触发；将其地址及 cookie 信息发送给改平台。

在接收面板获得信息；

![[attachments/20250412171983.png]]
