...
![[attachments/20250312105334.png]]
...
判断是数字型还是字符型，即注入的时候是否需要添加引号，一般使用：`1 and 1=1`、`1 and 1=2` 和 `1' and '1'='1`、`1' and '1'='2` 进行判断。

输入 `1 and 1=1`、`1 and 1=2` 都显示正常；输入 `1' and '1'='1`、`1' and '1'='2` 前者正常，后者不显示，说明单引号起了作用，可以判断注入类型为字符型；

![[attachments/20250312111454.png]]
...
![[attachments/20250312112926.png]]
...
![[attachments/20250312203826.png]]
...
![[attachments/20250313161854.png]]

`substr()`来依次判断数据库名；

![[attachments/20250313162025.png]]

无法查看有多少个表，为避免无效查询，先获取表的数量；`count()`统计数据表中包含的记录行的总数，或根据查询结果返回列中包含的数据行；

![[attachments/20250313162535.png]]

获取表名长度；

![[attachments/20250313162918.png]]

获取具体的表名；

![[attachments/20250313164111.png]]

获取字段名；

列数；

![[attachments/20250313164437.png]]

列名长；

![[attachments/20250313164846.png]]

列名；

![[attachments/20250313164948.png]]

具体数据记录长度；

![[attachments/20250313165227.png]]

具体数据；

![[attachments/20250313165422.png]]
...
![[attachments/20250313172732.png]]

判断数据库名长度；

![[attachments/20250313172916.png]]

猜测数据库名；

![[attachments/20250313173129.png]]
...
![[attachments/20250313204120.png]]

获取数据表名；

![[attachments/20250313204612.png]]
...
![[attachments/20250313214139.png]]
...
![[attachments/20250313215006.png]]
...
![[attachments/20250316150721.png]]
...
![[attachments/20250314110837.png]]

![[attachments/20250314110924.png]]
...
![[attachments/20250314114418.png]]

![[attachments/20250314114443.png]]
